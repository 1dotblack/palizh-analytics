...
| ----------- | ------------- | ------- |
| **Аналитика (этот репозиторий)** | [github.com/1dotblack/palizh-analytics](https://github.com/1dotblack/palizh-analytics) • `origin` | ЧТЗ, Инфарх, понимание задачи, интервью, **продуктовые** OpenAPI (`openapi_client_mvp.yaml`, `openapi_1c_inbound_mvp.yaml`, merged и черновики), копии интеграционных файлов из GitLab (**синхронизировать** после правок там) |
