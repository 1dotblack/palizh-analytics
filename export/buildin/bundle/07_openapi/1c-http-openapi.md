# Платформа → 1С (1c-http)

<!-- buildin-source: Техническая часть/1c-http-openapi.yaml -->
  ...
  schemas:
    ...
    OrderCreateItem:
      ...
      properties:
        ...
        productCharacteristicGuid:
          type: string
          format: uuid
          description: GUID характеристики товара в 1С.
    ...
    OrderCreateResponse:
      ...
      properties:
        orderNumber:
          type: string
          description: Номер созданного заказа в 1С.
          example: НВ00-003086
