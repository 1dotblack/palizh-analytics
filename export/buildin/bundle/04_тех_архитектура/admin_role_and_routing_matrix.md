<!-- buildin-source: Техническая часть/admin_role_and_routing_matrix.md -->
...
| Справочник групп оттенков (HSL, на категорию) | Да | Да | Нет |
...
| Фильтры каталога | Вкл/выкл, порядок, override подписи facet-фильтров (ЧТЗ 12 §4.2.2) | Справочник атрибутов и значений — из `1С` |
| SEO каталога | SEO-профили листингов: категория + curated facet-landings (ЧТЗ 12 §4.2.3, ЧТЗ 06 §4.2.6) | ЧПУ facet-landings, SEO групп оттенков — post-MVP |
| Группы оттенков | Именованные группы фильтра «Оттенки цветов», HSL-диапазоны, плашка HEX — **на категорию** (ЧТЗ 06 §4.2.5, ЧТЗ 12 §4.2.1) | HEX / RAL / название оттенка на характеристике варианта — из `1С` |
