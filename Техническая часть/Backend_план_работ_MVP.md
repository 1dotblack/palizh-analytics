...
| A.2 | **JWT** auth: регистрация/активация по сценарию ЧТЗ 05 (минимально — вход по email+password, refresh по решению) | Защищённые роуты | **4–8** | согласование с UX/ЧТЗ 05 |
...
| F.4 | Поиск: интеграция Ensi / заглушка с PG `ILIKE` на MVP-risk | **5–15** | **Высокий разброс** — зависит от контракта Ensi |
...
1. Объём **MVP-поиска** (Ensi с первого дня vs упрощение).  
