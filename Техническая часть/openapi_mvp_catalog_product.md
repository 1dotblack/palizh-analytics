...
- **Поиск и листинг:** недоступные зрителю позиции **не** попадают в выдачу (каталог, поиск, в т.ч. Ensi — индекс/запрос с учётом видимости; без «пустых» или бесправных ссылок в результатах).
