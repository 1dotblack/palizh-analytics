...
**Статус:** зафиксировано **по согласованию с тимлидом** (черновики в `входящие/`, 2026).  
**Канон OpenAPI:** `openapi_1c_inbound_mvp.yaml` (1С → платформа), `1c-http-openapi.yaml` (платформа → 1С).  
**Детали и примеры JSON:** `входящие/incoming-hooks.md` (события) и `входящие/1c-http-openapi.yaml` (черновик путей 1С).
...
- Черновик тимлида в **`входящие/`** оставлен как **исходник переговоров**; расхождения с каноном — **по YAML в `Техническая часть/`**.
